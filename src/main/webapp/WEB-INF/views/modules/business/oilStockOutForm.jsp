...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/business/oilStockOut/">出库表列表</a></li>
		<li class="active"><a href="${ctx}/business/oilStockOut/form?id=${oilStockOut.id}">出库表<shiro:hasPermission name="business:oilStockOut:edit">${not empty oilStockOut.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="business:oilStockOut:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oilStockOut" action="${ctx}/business/oilStockOut/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="business:oilStockOut:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
